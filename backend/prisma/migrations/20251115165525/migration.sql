/*
  ...
  - You are about to drop the column `startingNumber` on the `Discussion` table. All the data in the column will be lost.
  - Added the required column `startingValue` to the `Discussion` table without a default value. This is not possible if the table is not empty.
